...
public class ModRegistries {
    ...
    private static void registerFlammableBlock() {
        ...
        instance.add(ModBlocks.PALE_OAK_WALL, 5, 20);
    ...
    private static void registerFuels() {
        ...
        FuelRegistryEvents.BUILD.register((builder, context) -> {
            builder.add(ModBlocks.OAK_WALL, 300);
            builder.add(ModBlocks.SPRUCE_WALL, 300);
            builder.add(ModBlocks.BIRCH_WALL, 300);
            builder.add(ModBlocks.JUNGLE_WALL, 300);
            builder.add(ModBlocks.ACACIA_WALL, 300);
            builder.add(ModBlocks.DARK_OAK_WALL, 300);
            builder.add(ModBlocks.MANGROVE_WALL, 300);
            builder.add(ModBlocks.CHERRY_WALL, 300);
            builder.add(ModBlocks.PALE_OAK_WALL, 300);
            builder.add(ModBlocks.BAMBOO_WALL, 300);
        });
    }
}
